...
using Tyuiu.MelehovAG.Sprint6.Task0.V11.Lib;
...
namespace Tyuiu.MelehovAG.Sprint6.Task0.V11
{
    public partial class FormMain : Form
    {
        ...
        {
            MessageBox.Show("Таск 0 выполнил студент группы ПКТБ-23-1 Мелехов Алексей Григорьевич", "Сообщение", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }

        private void pictureBoxFormula_SDA_Click(object sender, EventArgs e)
        {
        ...
        private void textBoxVarX_SDA_TextChanged(object sender, EventArgs e)
        {
